...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String KEY_PAYMENT_METHOD_INCOME = "payment_method"; // DOUBLE
    ...
    private static final String KEY_DESCRIPTION_INCOME = "description"; //VARCHAR(300)
    private static final String KEY_TAX_INCOME = "tax";  //DOUBLE
    private static final String KEY_QUANTITY_INCOME = "quantity"; //INTEGER
    private static final String KEY_PAYEE_INCOME = "payee"; //VARCHAR(30)
    private static final String KEY_TAGS_INCOME = "tags"; //VARCHAR(30)
    ...
    public static final String CREATE_INCOME_TABLE = "CREATE TABLE " + TABLE_INCOME +
            "(" + KEY_ID_INCOME + " INTEGER PRIMARY KEY AUTOINCREMENT, " + KEY_AMOUNT_INCOME + " DOUBLE,"+KEY_PAYMENT_METHOD_INCOME +
            " STRING,"+ KEY_DATE_INCOME + " DATETIME, "+KEY_REF_CHECK_INCOME+" INTEGER,"+KEY_DESCRIPTION_INCOME+" VARCHAR(300), "
            +KEY_TAX_INCOME+" DOUBLE, "+KEY_QUANTITY_INCOME+" INTEGER, "+KEY_PAYEE_INCOME+" VARCHAR(30), "+KEY_TAGS_INCOME+" VARCHAR(30) )";
...
//    }
    ...
    public void addIncomeTransaction(Transaction transaction){
        ...
        values.put(KEY_DATE_INCOME, String.valueOf(transaction.getKEY_DATE()));
        values.put(KEY_REF_CHECK_INCOME, transaction.getKEY_REF_CHECK());
        values.put(KEY_DESCRIPTION_INCOME, transaction.getKEY_DESCRIPTION());
        values.put(KEY_TAX_INCOME, transaction.getKEY_TAX());
        values.put(KEY_QUANTITY_INCOME, transaction.getKEY_QUANTITY());
        values.put(KEY_PAYEE_INCOME, transaction.getKEY_PAYER());
    ...
    //retrieve a specific income transaction
    public Transaction getIncomeTransaction(int id)throws ParseException {
        //TODO

        SQLiteDatabase db = this.getReadableDatabase();

        String query = "SELECT * FROM " + TABLE_INCOME + " WHERE " +KEY_ID_INCOME+" = "+id;
    ...
    public ArrayList<Transaction> getAllIncomeTransactions() throws ParseException {
        ArrayList<Transaction> transactionList = new ArrayList<>();
        String query = "SELECT * FROM " + TABLE_INCOME;
    ...
    public void updateIncomeTransaction(Transaction transaction){
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        db.update(TABLE_INCOME, values, KEY_ID_INCOME +" = "+transaction.getKEY_ID(), null);
        db.close();


    }

    //delete all income transaction
    public void deleteAllIncomeTransactions(){
        String query = "DELETE FROM " + TABLE_INCOME;
    ...
    public void deleteIncomeTransaction(int id){
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        db.delete(TABLE_INCOME, KEY_ID_INCOME + "=" + id, null);
        db.close();
    }
